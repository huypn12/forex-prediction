...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth,keepaspectratio]{figs/lstm.png}
...
consecutives timesteps. The rationale of training is that: \textit{given
  $\mathbf{x_i}$ at last 25 timesteps, we want to observe the next $y_i$}
\begin{figure}[H]
  \centering
