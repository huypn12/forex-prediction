...
\textit{ARIMA(p,d,q)} consists of three models: $AR(p)$, $MA(q)$ and integrated series of order d.\\
...
\begin{figure}
  ...
  \caption{ARIMA(1,1,18) On Open price. RMSE=, MAPE=}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\linewidth,keepaspectratio]{figs/arima_2_1_25_high.png}
  \caption{ARIMA(2,1,25) On High price. RMSE=, MAPE=}
\end{figure}
